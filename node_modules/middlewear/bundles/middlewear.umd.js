(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('middlewear', ['exports', '@angular/core', '@angular/common/http'], factory) :
    (factory((global.middlewear = {}),global.ng.core,global.ng.common.http));
    ...
    var MiddlewareService = /** @class */ (function () {
        function MiddlewareService(http) {
            ...
            this.facets = new i0.EventEmitter();
            this.breadcrumbs = new i0.EventEmitter();
        }
        /**
         * @param {?=} url
         * @return {?}
        ...
        /** @nocollapse */
        MiddlewareService.ctorParameters = function () {
            return [
                { type: i1.HttpClient }
            ];
        };
     ...
     */
    /** @type {?} */
    var API_HOST = new i0.InjectionToken('API_HOST');
    ...
    exports.MiddlewearModule = MiddlewearModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=middlewear.umd.js.map